...
fills/closes). `signals/candidates.json` remains the same stale Jul 15 funnel snapshot (~68 days
...
NATHALI-01/BALLI-01 and RMAT designation intact.
...
2026-07-12 6-K). Stock down ~88% over the trailing year, employee options repriced to $1.30, and
Mudrick Capital (distressed-debt investor) gaining expanded consent rights at the Sept 11 AGM.
...
patients dosed and generally well tolerated, FDA meeting on accelerated approval and Phase III
plans still expected Q4 2026. No adverse signal.

**TISI — HOLD** | opened Jun 4
Balance sheet strengthened (ABL facility maturity extended to Sept 2027, lower rate spread),
insider bought stock 2026-09-08, Stellex Capital consolidated the Corre Partners block. No
fraud/halt/failed-binary-event found. Turnaround thesis stands.
