...
**APLD — HOLD**  
Opened Jun 9, +1.40% ($41.44 → $42.02). Applied Digital filed a fresh 8-K Jun 9 (in candidates). AI/HPC data center thesis is one day old and still live; green on a −2.33% Tech tape. Catalyst not spent.

**ATHE — HOLD**  
Opened Jun 9, +2.36% ($4.23 → $4.33). Alterity Therapeutics — FDA acceptance of Phase 3 plan for MSA drug (slowed decline 48%; Bullish 0.42, published Jun 9). FDA accepting the Phase 3 trial design is the *start* of the clinical story, not the end. Intraday +19% pop fading to +2.36% is normal biotech behavior on a risk-off tape. No adverse event.

**AVR — HOLD**  
Opened Jun 8, −4.05% ($9.87 → $9.47). Not in today's candidates; no adverse news identified. Drawdown is market-correlated (broad risk-off day). Cannot sell on a 4% pullback with no thesis-breaking event.

**EVTL — HOLD**  
Opened Jun 9, −0.94% ($2.12 → $2.10). Vertical Aerospace — "flies final prototype ahead of Critical Design Review" (candidates Jun 9, Bullish 0.487). The CDR milestone itself lies ahead; the prototype flight is supportive progress, not the conclusion. Trivial drawdown. Thesis intact.

**GASS — HOLD**  
Opened Jun 5, −1.26% ($9.51 → $9.39). StealthGas — Seeking Alpha Jun 9: "The Rally Has Not Fully Closed The Value Gap" (Neutral 0.04). Article explicitly asserts the value thesis is unspent; no adverse shipping news. Small loss, no reason to exit.
...
**TISI — HOLD**  
Opened Jun 4, −3.26% ($18.09 → $17.50). Team Inc. — no candidates entry, no contract cancellation or earnings miss. Industrials sector fell −0.91% Jun 9; decline is sector drag. Thesis intact.
...
|--------|--------|----------|--------------------------------------|----------|
| APLD   | Jun 9  | +1.40%   | Yes (8-K fresh)                      | HOLD — AI/HPC catalyst live, green on red tape |
| ATHE   | Jun 9  | +2.36%   | Yes (FDA Phase 3 nod, Bullish 0.42)  | HOLD — Phase 3 plan begins the thesis, doesn't end it |
| AVR    | Jun 8  | −4.05%   | No                                   | HOLD — no adverse news; drawdown alone not a sell |
