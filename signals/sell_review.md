...
Small pharma/biotech. Trivial −1.89% is Healthcare sector noise on a risk-off day. No adverse clinical or regulatory events in candidates. HOLD.

**AVR — HOLD** | opened Jun 8, −3.75% unrealized
Three-day −3.75% drift on a broad risk-off tape with no company-specific adverse events visible in candidates or headlines. HOLD.

**BNAI — HOLD** | opened Jun 10, +5.24% unrealized
Book's only green position on a risk-off day — exceptional relative strength signals live catalyst still working. No reason to exit a winner mid-move. HOLD.

**CLLS — HOLD** | opened Jun 10, −0.94% unrealized
Essentially flat on Healthcare's worst tape day; thesis is early-stage and just beginning. No adverse events in candidates. HOLD.

**EVTL — HOLD** | opened Jun 9, −0.94% unrealized
Vertical Aerospace (eVTOL). Trivial −0.94% drawdown; no adverse programme or operational news visible. HOLD.

**GASS — HOLD** | opened Jun 5, −1.68% unrealized
StealthGas (LPG tanker). Six-day −1.68% in Energy −0.83% / risk-off tape; contracted backlog and balance-sheet thesis unchanged. No adverse shipping or corporate news in candidates. HOLD.
