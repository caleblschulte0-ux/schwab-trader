...
```
=== Executor | SIM | preset=balanced | 2026-09-22 23:07Z ===
...
account: equity=$1,000.00 cash=$1,000.00 hwm=$1,000.00 managed_capital=$1,000.00 | 1253 min to close
...
(data) live prices for 37/37 symbols
  ...
  strategy: defensive 23% -> ['BIL']
  momentum holdings: ['DBC', 'EEM', 'QQQ', 'SMH', 'USO', 'XBI', 'XLE', 'XLK']
  regime: breadth=0.655
  regime: risk_off=False
  regime: core=QQQ
  regime: exposure=0.767
  regime: defensive=['BIL']
targets: QQQ 35%, BIL 23%, XLE 8%, DBC 8%, EEM 7%, XLK 6%, XBI 6%, SMH 4%, USO 3%
9 order(s):
  BUY QQQ $350.00 -> filled filled_qty=0.468018 avg=747.8338
  BUY BIL $232.93 -> filled filled_qty=2.542466 avg=91.6158
...
done: equity=$999.50 cash=$2.00 positions=['BIL', 'DBC', 'EEM', 'QQQ', 'SMH', 'USO', 'XBI', 'XLE', 'XLK'] max drift vs target=$1.98
```
